                                                      ...
                                                      children: [
                                                        ...
                                                        Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              '${DateTime.parse(post['comments'][i]['created_at']).year}-${DateTime.parse(post['comments'][i]['created_at']).month}-${DateTime.parse(post['comments'][i]['created_at']).day} ${DateTime.parse(post['comments'][i]['created_at']).toLocal().hour}:${DateTime.parse(post['comments'][i]['created_at']).toLocal().minute}',
                                                              style: TextStyle(
                                                                  fontSize: 12),
                                                            )
                                                          ],
                                                            ...
                                                            ? Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    commentPv.deleteComment(post['comments'][i]['id']).then((value){
